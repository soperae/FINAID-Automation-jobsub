...
SCRIPT_LOG="/opt2/jwu/log/jwu_tdclient_finaid_automation-B.log"
	

DTE=`date`
echo "$DTE rcpmtch${TWODIGIT} sqlplus started" | tee -ai $SCRIPT_LOG
...
DTE=`date`
LIST="${HOME}/rcpmtch_${ONE_UP_NUM}.lis"
